...
export default function RegisterPage() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        e.preventDefault()
        if (!whatsapp.trim() || !fullName.trim() || !email.trim() || !password) {
            ...
            <Card className="w-full max-w-md border border-border">
                            ...
                            <Card className="w-full max-w-sm">
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        ...
                                        />
                                        <Button className="w-full" onClick={verifyOtp} disabled={verifying || otpCode.length < 6}>
                                            {verifying && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                                            Verifikasi
                                        </Button>
                                        <Button variant="ghost" className="w-full" onClick={() => setShowOtpModal(false)}>Batal</Button>
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
                ...
                <CardFooter className="flex justify-center">
                    <p className="text-sm text-muted-foreground">
                        Sudah punya akun? <Link href="/login" className="text-foreground underline hover:no-underline">Login</Link>
                    </p>
                </CardFooter>
            </Card>
        </div>
